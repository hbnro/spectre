...
describe('About let()', function () {
    ...
    describe('callbacks inside tests', function () {
        it('should share context locally', function () {
    ...
    describe('objects within inner tests', function () {
...
xdescribe("Pending groups are declared using 'xdescribe'");
